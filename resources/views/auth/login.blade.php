...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('images/logo-2.svg') }}">
    <title>Shop stream</title>
    <!--toastr -->
    ...
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center" style="background:url(../../assets/images/big/auth-bg.jpg) no-repeat center center;">
            <div class="auth-box">
                <div id="loginform">
                    <div class="logo">
                        <span class="db"><img src="{{ asset('images/logo-2.svg') }}" alt="logo" /></span>
                                ...
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            {{-- <a href="{{ route('password.forgot_password') }}" class="text-dark float-right"><i class="fa fa-lock mr-1"></i> Forgot password?</a> --}}
                                        </div>
                                    </div>
                                </div>
